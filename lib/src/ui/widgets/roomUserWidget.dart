...
class roomUserWidget extends StatefulWidget {
  ...
  String time;
  bool isMessageRead;
  roomUserWidget({required this.text,required this.secondaryText,required this.image,required this.time,required this.isMessageRead});

  @override
  State<roomUserWidget> createState() => _roomUserWidgetState();
}

class _roomUserWidgetState extends State<roomUserWidget> {
  @override
